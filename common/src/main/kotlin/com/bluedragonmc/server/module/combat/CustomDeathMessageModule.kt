...
@DependsOn(GameStateModule::class)
            ...
            event.chatMessage = when (val src = event.player.lastDamageSource) {
                is EntityDamage -> {
                    ...
                    if (playerName != null) {
                        ...
                        Component.translatable("death.attack.mob", BRAND_COLOR_PRIMARY_2, player.name, Component.translatable(src.source!!.entityType.translationKey()))
                    }
                }
                is EntityProjectileDamage -> {
                    ...
                    if (playerName != null) {
                        ...
                        Component.translatable("death.attack.arrow", BRAND_COLOR_PRIMARY_2, player.name, Component.translatable(src.shooter!!.entityType.translationKey()))
                    } else {
